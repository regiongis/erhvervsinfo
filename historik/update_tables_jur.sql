...
-- REFRESH MATERIALIZED VIEW cvr.cvr_jur_enhed_adresser;
-- REFRESH MATERIALIZED VIEW cvr.cvr_jur_enhed_ansatte_aar;
-- REFRESH MATERIALIZED VIEW cvr.cvr_jur_enhed_ansatte_kvartal;
-- REFRESH MATERIALIZED VIEW cvr.cvr_jur_enhed_hovedbranche;
