-- CREATE OR REPLACE FUNCTION cvr.update_tables() RETURNS void AS $$
...
UPDATE cvr.cvr_prod_enhed_geo_stam AS stam
  ...
  --AND dump.indlaest_dato = '2017-06-01'
  --AND dump.indlaest_dato = '2017-07-01'
  --AND dump.indlaest_dato = '2017-08-01'
  --AND dump.indlaest_dato = '2017-09-01'
  --AND dump.indlaest_dato = '2017-10-01'
  --AND dump.indlaest_dato = '2017-11-01'
  --AND dump.indlaest_dato = '2017-12-01'
  --AND dump.indlaest_dato = '2018-01-01'
  AND dump.indlaest_dato = '2018-02-01'
...
INSERT INTO cvr.cvr_prod_enhed_geo_hist_ansatte_aar (
  ...
  AND   ((cvr.cvr_prod_enhed_geo_hist_ansatte_aar.aarsbeskaeftigelse_aar != stam.aarsbeskaeftigelse_aar) OR
        (cvr.cvr_prod_enhed_geo_hist_ansatte_aar.aarsbes_antalansatte != stam.aarsbes_antalansatte) OR
        (cvr.cvr_prod_enhed_geo_hist_ansatte_aar.aarsbes_antalaarsvaerk != stam.aarsbes_antalaarsvaerk) OR
        (cvr.cvr_prod_enhed_geo_hist_ansatte_aar.aarsbes_antalinclejere != stam.aarsbes_antalinclejere)));
...
INSERT INTO cvr.cvr_prod_enhed_geo_hist_ansatte_kvartal (
  ...
  AND    ((cvr.cvr_prod_enhed_geo_hist_ansatte_kvartal.kvartalsbeskaeftigelse_aar != stam.kvartalsbeskaeftigelse_aar) OR
         (cvr.cvr_prod_enhed_geo_hist_ansatte_kvartal.kvartalsbeskaeftigelse_kvartal != stam.kvartalsbeskaeftigelse_kvartal) OR
         (cvr.cvr_prod_enhed_geo_hist_ansatte_kvartal.kvartalsbeskaeftigelse_antalansatte != stam.kvartalsbeskaeftigelse_antalansatte) OR
